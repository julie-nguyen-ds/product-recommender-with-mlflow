...
data = {
    "dataframe_split": {
        "columns": ["user_id", "current_product_id", "n_recommendations"],
        "data": [["User7", "Product10", 3]],
    }
}
...
df = df.withColumn("datetime", from_unixtime(df.timestamp_ms / 1000, "yyyy-MM-dd HH:mm:ss.SSS"))
display(df)
